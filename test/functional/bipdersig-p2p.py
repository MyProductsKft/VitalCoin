...
class BIP66Test(VitalCoinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # vitalcoind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and vitalcoind produces more specific reject
            # reasons.
