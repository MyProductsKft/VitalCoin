...
# TestP2PConn: A peer we use to send messages to vitalcoind, and store responses.
...
class CompactBlocksTest(VitalcoinTestFramework):
    ...
    # This test actually causes vitalcoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that vitalcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for vitalcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # vitalcoind will not send blocktxn responses for blocks whose height is
