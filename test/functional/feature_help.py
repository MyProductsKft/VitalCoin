...
"""Verify that starting vitalcoin with -h works as expected."""

from test_framework.test_framework import VitalcoinTestFramework
from test_framework.util import assert_equal

class HelpTest(VitalcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start vitalcoin with -h for help text")
        ...
        self.log.info("Start vitalcoin with -version for version information")
        ...
        self.log.info("Start vitalcoind with -fakearg to make sure it does not start")
