...
Build output expected:
  ...
  4. OS X unsigned installer and dist tarball (`vitalcoin-${VERSION}-osx-unsigned.dmg`, `vitalcoin-${VERSION}-osx64.tar.gz`)
...
Add other gitian builders keys to your gpg keyring, and/or refresh keys.
    ...
    gpg --import vitalcoin/contrib/gitian-keys/*.pgp
    gpg --refresh-keys
...
Codesigner only: Sign the osx binary:
    ...
    transfer vitalcoin-osx-unsigned.tar.gz to osx for signing
