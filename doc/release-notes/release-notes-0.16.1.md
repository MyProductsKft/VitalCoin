Vitalcoin Core version 0.16.1 is now available from:

  <https://vitalcoincore.org/bin/vitalcoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting vitalcoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure vitalcoind processes are cleaned up when tests end (sdaftuar)
