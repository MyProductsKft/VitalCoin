Vitalcoin Core version *0.15.0.1* is now available from:

  <https://vitalcoin.org/bin/vitalcoin-core-0.15.0.1/>

and

  <https://vitalcoincore.org/bin/vitalcoin-core-0.15.0.1/>
