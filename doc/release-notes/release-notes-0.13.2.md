VitalCoin Core version 0.13.2 is now available from:

  <https://vitalcoin.org/bin/vitalcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update vitalcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow vitalcoin-tx to create v2 transactions (btcdrak)
