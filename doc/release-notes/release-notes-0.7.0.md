...
source-only tarballs/zipballs directly from there:
  https://github.com/vitalcoin/vitalcoin/tarball/v0.7.0  # .tar.gz
  https://github.com/vitalcoin/vitalcoin/zipball/v0.7.0  # .zip
...
in your terminal, then install the vitalcoin-qt package:
  sudo apt-get install vitalcoin-qt
...
Core vitalcoin handling and blockchain database
...
* Ensure a changed vitalcoin unit immediately updates all GUI elements that use units
...
* (Windows only): enable ASLR and DEP for vitalcoin-qt.exe
* (Windows only): add meta-data to vitalcoin-qt.exe (e.g. description)
...
* Bash programmable completion for vitalcoind(1)
