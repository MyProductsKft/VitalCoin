VitalCoin Core version 0.9.2.1 is now available from:

  https://vitalcoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 VTC to 0.01 VTC
...
- Fix "Start vitalcoin on system login"
