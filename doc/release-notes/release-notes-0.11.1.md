VitalCoin Core version 0.11.1 is now available from:

  <https://vitalcoin.org/bin/vitalcoin-core-0.11.1/>
...
(see https://github.com/vitalcoin/vitalcoin/pull/6795).
...
one was randomly violated by all deployed vitalcoin software prior to
...
(see https://github.com/vitalcoin/vitalcoin/pull/6793, as well as the 0.11
...
- #6571 `100ac4e` libvitalcoinconsensus: avoid a crash in multi-threaded environments
