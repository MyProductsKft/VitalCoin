...
This document provides guidelines for internationalization of the VitalCoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `vitalcoin_en.ts` remains unchanged.
