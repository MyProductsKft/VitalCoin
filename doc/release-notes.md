Vitalcoin Core version *0.15.2* is now available from:

  <https://vitalcoincore.org/bin/vitalcoin-core-0.15.2/>

or

  <https://vitalcoin.org/bin/vitalcoin-core-0.15.2/>
...
Vitalcoin Core versions 0.14.0 up to 0.16.2. It is recommended to upgrade any of
...
- #11554 `a69cc07` Sanity-check script sizes in vitalcoin-tx (TheBlueMatt)
