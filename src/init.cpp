...
std::string HelpMessage(HelpMessageMode mode) {
  ...
  strUsage += HelpMessageOpt(
      "-conf=<file>", strprintf(_("Specify configuration file (default: %s)"),
                                VITALCOIN_CONF_FILENAME));
  if (mode == HMM_VITALCOIND) {
#if HAVE_DECL_DAEMON
    strUsage += HelpMessageOpt(
  ...
  strUsage += HelpMessageOpt(
      "-pid=<file>",
      strprintf(_("Specify pid file (default: %s)"), VITALCOIN_PID_FILENAME));
#endif
  strUsage += HelpMessageOpt(
      "-prune=<n>",
...
bool AppInitParameterInteraction() {
  ...
  if (gArgs.GetBoolArg("-disablefork", false)) {
    printf(
        "NOTE: disabling fork; this node will run on the vitalcoin network\n");
    FORK_ALLOWED = false;
