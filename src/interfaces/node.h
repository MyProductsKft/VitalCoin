...
#ifndef VITALCOIN_INTERFACES_NODE_H
#define VITALCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a vitalcoin node (vitalcoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // VITALCOIN_INTERFACES_NODE_H
