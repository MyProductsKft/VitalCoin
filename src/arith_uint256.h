...
#ifndef VITALCOIN_ARITH_UINT256_H
#define VITALCOIN_ARITH_UINT256_H
...
public:
   ...
   *
   * VitalCoin only uses this "compact" format for encoding difficulty
...
#endif // VITALCOIN_ARITH_UINT256_H
