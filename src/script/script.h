...
#ifndef VITALCOIN_SCRIPT_SCRIPT_H
#define VITALCOIN_SCRIPT_SCRIPT_H
...
public:
  ...
  /**
   * Pre-version-0.6, VitalCoin always counted CHECKMULTISIGs
...
#endif // VITALCOIN_SCRIPT_SCRIPT_H
