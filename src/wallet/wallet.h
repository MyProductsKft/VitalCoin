...
#ifndef VITALCOIN_WALLET_WALLET_H
#define VITALCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this vitalcoin node, and set to 0 for transactions that were created
...
#endif // VITALCOIN_WALLET_WALLET_H
