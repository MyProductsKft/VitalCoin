#ifndef VITALCOIN_CHAINPARAMSSEEDS_H
#define VITALCOIN_CHAINPARAMSSEEDS_H
/**
 * List of fixed seed nodes for the vitalcoin network
...
#endif // VITALCOIN_CHAINPARAMSSEEDS_H
