...
#ifndef VITALCOIN_CLIENTVERSION_H
#define VITALCOIN_CLIENTVERSION_H
...
#error Client version information missing: version is not defined by vitalcoin-config.h or in any other way
#endif
...
/**
 * vitalcoind-res.rc includes this file, but it cannot cope with real c++ code.
...
#endif // VITALCOIN_CLIENTVERSION_H
