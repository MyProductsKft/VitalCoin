...
static int AppInitRawTx(int argc, char *argv[]) {
  ...
  if (argc < 2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") ||
    ...
    std::string strUsage =
        strprintf(_("%s vitalcoin-tx utility version"), _(PACKAGE_NAME)) + " " +
        FormatFullVersion() + "\n\n" + _("Usage:") + "\n" +
        "  vitalcoin-tx [options] <hex-tx> [commands]  " +
        _("Update hex-encoded vitalcoin transaction") + "\n" +
        "  vitalcoin-tx [options] -create [commands]   " +
        _("Create hex-encoded vitalcoin transaction") + "\n" + "\n";
