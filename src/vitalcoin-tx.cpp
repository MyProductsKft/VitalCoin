...
static void SetupVitalcoinTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " vitalcoin-tx utility version " + FormatFullVersion() + "\n\n" +
                               "Usage:  vitalcoin-tx [options] <hex-tx> [commands]  Update hex-encoded vitalcoin transaction\n" +
                               "or:     vitalcoin-tx [options] -create [commands]   Create hex-encoded vitalcoin transaction\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded vitalcoin transaction
