 ...
 */
#ifndef VITALCOIN_UTIL_H
#define VITALCOIN_UTIL_H
...
extern const char* const VITALCOIN_CONF_FILENAME;
extern const char* const VITALCOIN_PID_FILENAME;
...
{
    std::string s = strprintf("vitalcoin-%s", name);
