...
public:
    explicit AmountSpinBox(QWidget* parent) : QAbstractSpinBox(parent),
                                              currentUnit(VitalcoinUnits::VTC),
    ...
    void fixup(QString& input) const
    {
        ...
        if (valid) {
            input = VitalcoinUnits::format(currentUnit, val, false, VitalcoinUnits::separatorAlways);
    ...
    {
        lineEdit()->setText(VitalcoinUnits::format(currentUnit, value, false, VitalcoinUnits::separatorAlways));
        Q_EMIT valueChanged();
    }
    ...
    QSize minimumSizeHint() const
    {
        if (cachedMinimumSizeHint.isEmpty()) {
            ...
            int w = fm.width(VitalcoinUnits::format(VitalcoinUnits::VTC, VitalcoinUnits::maxMoney(), false, VitalcoinUnits::separatorAlways));
...
#include <qt/vitalcoinamountfield.moc>

VitalcoinAmountField::VitalcoinAmountField(QWidget* parent) : QWidget(parent),
                                                              amount(0)
{
