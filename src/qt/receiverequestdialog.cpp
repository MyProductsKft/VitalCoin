...
#include <config/vitalcoin-config.h> /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    if (info.amount)
        html += "<b>" + tr("Amount") + "</b>: " + VitalcoinUnits::formatHtmlWithUnit(model->getOptionsModel()->getDisplayUnit(), info.amount) + "<br>";
