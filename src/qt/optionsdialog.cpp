                                                                   ...
                                                                   mapper(0)
{
    ...
    ui->vitalcoinAtStartup->setToolTip(ui->vitalcoinAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->vitalcoinAtStartup->setText(ui->vitalcoinAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openVitalcoinConfButton->setToolTip(ui->openVitalcoinConfButton->toolTip().arg(tr(PACKAGE_NAME)));
...
{
    /* Main */
    mapper->addMapping(ui->vitalcoinAtStartup, OptionsModel::StartAtStartup);
