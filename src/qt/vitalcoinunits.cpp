...
VitalcoinUnits::VitalcoinUnits(QObject* parent) : QAbstractListModel(parent),
...
QString VitalcoinUnits::longName(int unit)
{
    switch (unit) {
    case VTC:
        return QString("VTC");
    case mVTC:
        return QString("mVTC");
    case uVTC:
        return QString::fromUtf8("µVTC (bits)");
    case SAT:
...
QString VitalcoinUnits::shortName(int unit)
{
    switch (unit) {
    case uVTC:
...
QString VitalcoinUnits::description(int unit)
{
    ...
    case uVTC:
        return QString("Micro-Vitalcoins (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    case SAT:
...
QString VitalcoinUnits::format(int unit, const CAmount& nIn, bool fPlus, SeparatorStyle separators)
{
...
QString VitalcoinUnits::formatWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators)
{
    return format(unit, amount, plussign, separators) + QString(" ") + shortName(unit);
}

QString VitalcoinUnits::formatHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators)
{
...
QString VitalcoinUnits::getAmountColumnTitle(int unit)
{
    ...
    if (VitalcoinUnits::valid(unit)) {
        amountTitle += " (" + VitalcoinUnits::shortName(unit) + ")";
    }
    return amountTitle;
}
...
CAmount VitalcoinUnits::maxMoney()
{
    return MAX_MONEY;
}
