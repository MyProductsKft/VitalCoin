...
static const char UNUSED *vitalcoin_strings[] = {
    ...
    QT_TRANSLATE_NOOP("vitalcoin-core", ""
                                        ...
                                        "with -debug=1 to output debug logs "
                                        "for all categories except one or more "
    ...
    QT_TRANSLATE_NOOP(
        ...
        "(default: %u)"),
    QT_TRANSLATE_NOOP("vitalcoin-core", ""
                                        "Warning: The network does not appear "
                                        "to fully agree! Some miners appear to "
    ...
    QT_TRANSLATE_NOOP("vitalcoin-core", "(default: %s)"),
    QT_TRANSLATE_NOOP("vitalcoin-core", "(default: %u)"),
    QT_TRANSLATE_NOOP("vitalcoin-core",
                      "(press q to shutdown and continue later)"),
    QT_TRANSLATE_NOOP("vitalcoin-core", "-maxmempool must be at least %d MB"),
    QT_TRANSLATE_NOOP("vitalcoin-core", "<category> can be:"),
    QT_TRANSLATE_NOOP("vitalcoin-core",
                      "Accept command line and JSON-RPC commands"),
    QT_TRANSLATE_NOOP("vitalcoin-core", "Accept connections from outside "
    ...
    QT_TRANSLATE_NOOP("vitalcoin-core", "Block creation options:"),
    QT_TRANSLATE_NOOP("vitalcoin-core", "Cannot downgrade wallet"),
    QT_TRANSLATE_NOOP("vitalcoin-core", "Cannot resolve -%s address: '%s'"),
    QT_TRANSLATE_NOOP("vitalcoin-core", "Cannot write default address"),
    QT_TRANSLATE_NOOP("vitalcoin-core", "Chain selection options:"),
    QT_TRANSLATE_NOOP("vitalcoin-core", "Change index out of range"),
    QT_TRANSLATE_NOOP("vitalcoin-core", "Connect through SOCKS5 proxy"),
    QT_TRANSLATE_NOOP(
        "vitalcoin-core",
        "Connect to a node to retrieve peer addresses, and disconnect"),
    QT_TRANSLATE_NOOP("vitalcoin-core", "Connection options:"),
    QT_TRANSLATE_NOOP("vitalcoin-core", "Copyright (C) %i-%i"),
    QT_TRANSLATE_NOOP("vitalcoin-core", "Corrupted block database detected"),
    QT_TRANSLATE_NOOP("vitalcoin-core", "Debugging/Testing options:"),
    QT_TRANSLATE_NOOP("vitalcoin-core",
    ...
    QT_TRANSLATE_NOOP("vitalcoin-core", "Error loading %s: You can't disable "
                                        "HD on an already existing HD wallet"),
    ...
    QT_TRANSLATE_NOOP("vitalcoin-core", "Listen for JSON-RPC connections on "
    ...
    QT_TRANSLATE_NOOP("vitalcoin-core", "Node relay options:"),
    QT_TRANSLATE_NOOP("vitalcoin-core",
                      "Not enough file descriptors available."),
    QT_TRANSLATE_NOOP(
        "vitalcoin-core",
        "Only connect to nodes in network <net> (ipv4, ipv6 or onion)"),
    QT_TRANSLATE_NOOP("vitalcoin-core", "Options:"),
    QT_TRANSLATE_NOOP("vitalcoin-core", "Password for JSON-RPC connections"),
    QT_TRANSLATE_NOOP("vitalcoin-core",
                      "Prepend debug output with timestamp (default: %u)"),
    QT_TRANSLATE_NOOP("vitalcoin-core", "Print this help message and exit"),
    QT_TRANSLATE_NOOP("vitalcoin-core", "Print version and exit"),
    QT_TRANSLATE_NOOP("vitalcoin-core",
    ...
    QT_TRANSLATE_NOOP("vitalcoin-core", "RPC server options:"),
    QT_TRANSLATE_NOOP(
        "vitalcoin-core",
        "Rebuild chain state and block index from the blk*.dat files on disk"),
    QT_TRANSLATE_NOOP("vitalcoin-core",
                      "Rebuild chain state from the currently indexed blocks"),
    QT_TRANSLATE_NOOP("vitalcoin-core", "Reducing -maxconnections from %d to "
    ...
    QT_TRANSLATE_NOOP("vitalcoin-core", "Specify data directory"),
    QT_TRANSLATE_NOOP("vitalcoin-core", "Specify pid file (default: %s)"),
    QT_TRANSLATE_NOOP("vitalcoin-core",
                      "Specify wallet file (within data directory)"),
    QT_TRANSLATE_NOOP("vitalcoin-core", "Specify your own public address"),
    QT_TRANSLATE_NOOP(
        "vitalcoin-core",
    ...
    QT_TRANSLATE_NOOP("vitalcoin-core", "Unable to bind to %s on this "
    ...
    QT_TRANSLATE_NOOP("vitalcoin-core", "Use the test chain"),
    QT_TRANSLATE_NOOP("vitalcoin-core",
                      "User Agent comment (%s) contains unsafe characters."),
    QT_TRANSLATE_NOOP("vitalcoin-core", "Username for JSON-RPC connections"),
    ...
    QT_TRANSLATE_NOOP("vitalcoin-core", "Wallet debugging/testing options:"),
    QT_TRANSLATE_NOOP("vitalcoin-core",
                      "Wallet needed to be rewritten: restart %s to complete"),
    QT_TRANSLATE_NOOP("vitalcoin-core", "Wallet options:"),
    ...
    QT_TRANSLATE_NOOP("vitalcoin-core", "ZeroMQ notification options:"),
};
