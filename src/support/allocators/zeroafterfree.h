...
#ifndef VITALCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define VITALCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // VITALCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
