...
public:
    CMainParams()
    {
        ...
        consensus.nPostForkSubsidyHalvingInterval = 460000;
        ...
        consensus.powLimit = uint256S("00000000ffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
        consensus.postForkPowLimit = uint256S("00000000ffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
        consensus.nPowTargetTimespan = 14 * 24 * 60 * 60; // two weeks
        consensus.nPowTargetSpacing = 10 * 60;
        ...
        vSeeds.emplace_back("seed.vitalcoin.sipa.be");          // Pieter Wuille, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("dnsseed.bluematt.me");             // Matt Corallo, only supports x9
        vSeeds.emplace_back("dnsseed.vitalcoin.dashjr.org");    // Luke Dashjr
        vSeeds.emplace_back("seed.vitalcoinstats.com");         // Christian Decker, supports x1 - xf
        vSeeds.emplace_back("seed.vitalcoin.jonasschnelli.ch"); // Jonas Schnelli, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("seed.btc.petertodd.org");          // Peter Todd, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("seed.vitalcoin.sprovoost.nl");     // Sjors Provoost
...
public:
    CTestNetParams()
    {
        ...
        vSeeds.emplace_back("testnet-seed.vitalcoin.jonasschnelli.ch");
        vSeeds.emplace_back("seed.tbtc.petertodd.org");
        vSeeds.emplace_back("seed.testnet.vitalcoin.sprovoost.nl");
...
public:
    CRegTestParams()
    {
        ...
        consensus.BIP34Height = 500; // This is deactivated on vitalcoin, but we activate it on the fork block here, as we otherwise won't get the fork hash coinbase
