...
public:
    ...
    int Period(const CBlockIndex* pindex, const Consensus::Params& params) const override { return 1000; }
    int Threshold(const CBlockIndex* pindex, const Consensus::Params& params) const override { return 900; }
