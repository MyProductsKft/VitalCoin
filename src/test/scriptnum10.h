...
#ifndef VITALCOIN_TEST_SCRIPTNUM10_H
#define VITALCOIN_TEST_SCRIPTNUM10_H
...
{
    /**
 * The ScriptNum implementation from Vitalcoin Core 0.10.0, for cross-comparison.
 */
public:
