...
unlocked to sign the Vitalcoin-Qt.app bundle.
...
allowing somebody to distribute a Vitalcoin-Qt.app or vitalcoin-qt-setup.exe with a valid
...
that the vitalcoin-qt.exe file inside the installer had not been tampered with.
